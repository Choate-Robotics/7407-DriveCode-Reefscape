...
robot_to_left_cam = Transform3d(
    Translation3d(
        8.210 * inches_to_meters, 9.764 * inches_to_meters, 7.911 * inches_to_meters
    ),
...
drivetrain_radius: meters = math.sqrt(
    math.pow(track_length / 2, 2) + math.pow(track_width / 2, 2)
)
reef_scoring_distance: meters = (
    drivetrain_length_with_bumpers / 2 + 2 * inches_to_meters
)
...
drivetrain_wheel_diameter: meters = 3.858 * inches_to_meters
