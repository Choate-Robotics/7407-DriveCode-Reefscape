...
class OI:
    ...
    def map_controls():
        ...
        Keymap.Intake.INTAKE_CORAL.and_(lambda: not Robot.wrist.algae_in_wrist).whileTrue(
        ...
        Keymap.Intake.INTAKE_L1.and_(lambda: not Robot.wrist.algae_in_wrist).whileTrue(
